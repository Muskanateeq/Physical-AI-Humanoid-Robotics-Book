...
export default function SignIn() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // signIn.social automatically creates account if user doesn't exist
      await signIn.social({
        provider: "google",
  ...
  return (
    <Layout title="Sign In" description="Sign in to Physical AI & Humanoid Robotics">
      <div className={styles.container}>
        <div className={styles.card}>
          <div className={styles.header}>
            <h1 className={styles.title}>Welcome Back</h1>
            <p className={styles.subtitle}>Sign in to access the AI Chatbot and more</p>
          </div>
