...
Compatible with Better Auth schema (camelCase field names).
"""
...
class User(SQLModel, table=True):
    ...
    This model is compatible with Better Auth schema.
    Better Auth uses camelCase column names (createdAt, updatedAt, emailVerified).
    Password management is handled by Better Auth, not stored here.
    """
    __tablename__ = "user"
